...
import be.docarch.odt2braille.ooo.dialog.elements.*;
...
public class SettingsDialog {
    ...
    private final static ProgressMonitor statusIndicator = Constants.getStatusIndicator();
    ...
    public SettingsDialog(XComponentContext ctxt,
        ...
        TranslationTable mainTranslationTable = settings.getMainTranslationTable();
        
        for (String locale : mainTranslationTable.locale.options()) {
            try {
