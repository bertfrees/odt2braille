...
public abstract class VolumeSplitter {
    ...
    public static List<AutoGeneratedVolume> splitBodyMatterVolume(Configuration configuration)
                                                           throws IOException,
                                                                  SAXException,
        ...
        OdtTransformer tranformer = configuration.odtTransformer;

        if ((configuration.getBodyMatterMode() == VolumeManagementMode.AUTOMATIC)) {

            tranformer.configure(configuration);
            SplittableVolume volumeSettings = configuration.getBodyMatterVolume();

            int[] allPages = tranformer.extractDocumentOutline();
            ...
            tranformer.splitInAutomaticVolumes(volumes);
        }
